...
description: |
  ...
  identify bottlenecks, or ensure scalability. The agent reviews database queries, memory usage,
  caching strategies, and overall system performance after features are implemented or when
...
examples:
  - context: "The user has just implemented a new feature that processes user data."
    ...
    commentary: "Since the user is concerned about scalability, launch the performance-oracle agent to analyze the code for performance issues."
