...
[![Skills](https://img.shields.io/badge/skills-34-black.svg)](docs/guides/README.md)
...
34 skills, grouped by what they are for. The full catalog, with a page per skill and how each one chains into the others, is in **[docs/guides](docs/guides/README.md)**.
