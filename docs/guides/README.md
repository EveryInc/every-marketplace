...
| Skill | Description |
|-------|-------------|
| [`/ce-noslop`](./ce-noslop.md) | Rewrite, check, or draft prose with no AI tells that reads on the first read; every claim preserved. Sibling skills invoke it where they write. |
