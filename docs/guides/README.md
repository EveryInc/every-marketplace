...
| Skill | Description |
|-------|-------------|
| [`/ce-bakeoff`](./ce-bakeoff.md) | Experimental independent candidate development, comparison, and winning synthesis for a defined brief. Direct use and explicitly requested planning/brainstorming trials. |
