...
| Skill | Description |
|-------|-------------|
| [`/ce-bakeoff`](./ce-bakeoff.md) | Experimental independent approach development and selection for better brainstorming and planning decisions. Explicitly requested workflow trials and standalone use. |
