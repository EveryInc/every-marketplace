...
Read and apply [Worktree preservation](worktree-safety.md) before any tree-changing operation here, including classification and the return to the work branch. Stack construction does not waive that condition.
