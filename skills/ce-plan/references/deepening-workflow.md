...
Allowed changes:
- Tighten prose in a strengthened section under `ce-noslop`'s tests: remove superseded text in place (version control holds the history), and replace unlinked restatements with citations of the owning R/KTD
