...
Invoke the `ce-noslop` skill in author mode before writing human-readable findings, and write them under its tests. Preserve exact code identifiers, error text, and every distinct consequence or required action.
