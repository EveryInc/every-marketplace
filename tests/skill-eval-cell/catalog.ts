...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    read_only: true,
    post_only: true,
    why: "A live run exposed internal bookkeeping in its opening and labeled workers as candidate artifacts.",
  ...
  },
  {
    ...
    task: "Use ce-bakeoff for BRIEF.md. Prepare the shared candidate brief, then stop before dispatch or writing. Emit a line beginning STORAGE_STATUS: stating what the common brief establishes about the storage API and what remains unknown.",
    grade: { workspace_read: ["BRIEF.md"], must_include_field: "STORAGE_STATUS", must_include: ["unknown"], actions: "none", delegates: "none" },
  },
  {
    ...
    task: "Use ce-bakeoff to finish only the timing section of this completed run's record, without dispatch or writing. The host log records START 2026-09-07T12:00:00Z and END 2026-09-07T12:09:52Z. The draft says 'about five minutes'. Report elapsed seconds and whether the draft is supported. Token and cost receipts are absent. Do not begin another competition.",
    grade: { must_include: ["592"], actions: "none", delegates: "none" },
  },
  {
  ...
  },
  {
    ...
    task: "Use ce-bakeoff for retry ownership. The team has explicitly settled that the SDK owns retries, and I want that decision preserved. There are no other open questions. State the next step without dispatching or writing.",
    grade: { must_include: ["settled"], actions: "none", delegates: "none" },
  },
  {
  ...
  },
  {
    ...
    task: "Use ce-plan at the end of research for a Standard Durable plan. Product scope is settled; retry ownership is an unresolved consequential HOW. I explicitly requested a Bake-off. State the next owning skill and what returns to planning; stop before dispatch or writing. No model override is configured.",
    grade: { files_read_post: ["references/research.md", "references/bakeoff.md"], must_include: ["ce-bakeoff"], actions: "none", delegates: "none" },
  },
  {
    ...
    task: "Use ce-brainstorm at Phase 2. Goals and constraints are settled and I explicitly requested a Bake-off for the onboarding mechanism. State the next owning skill, how its result is presented, and who confirms product scope; stop before generation, dispatch or writing. No model override is configured.",
    grade: { files_read_post: ["references/approaches.md", "references/bakeoff.md"], must_include: ["ce-bakeoff", "recommendation"], actions: "none", delegates: "none" },
  },
  {
